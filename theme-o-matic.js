...
svgElement.outerHTML = currentThemeSetting === "dark" ? sunSVG : moonSVG;
button.setAttribute("aria-label", `Change to ${currentThemeSetting === "dark" ? "light" : "dark"} theme`);

button.addEventListener("click", () => {
    const newTheme = currentThemeSetting === "dark" ? "light" : "dark";
    const newSVG = newTheme === "dark" ? sunSVG : moonSVG;
